        ...
        >
          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <a href="mailto:vishupatel575@gmail.com" className="text-neon-blue hover:underline">
                  vishupatel575@gmail.com
                </a>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-400">+1 (437) 660-3847</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8">
            ...
            <div className="flex space-x-4">
              <a href="https://github.com/VishuPatel-27" target='_blank' rel="noreferrer" className="w-10 h-10 rounded-lg bg-glass-secondary hover:bg-glass-accent transition-colors duration-300 flex items-center justify-center">
              ...
              <a href="https://www.linkedin.com/in/vishu-patel/" target='_blank' rel="noreferrer" className="w-10 h-10 rounded-lg bg-glass-secondary hover:bg-glass-accent transition-colors duration-300 flex items-center justify-center">
                <svg className="h-5 w-5 text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
